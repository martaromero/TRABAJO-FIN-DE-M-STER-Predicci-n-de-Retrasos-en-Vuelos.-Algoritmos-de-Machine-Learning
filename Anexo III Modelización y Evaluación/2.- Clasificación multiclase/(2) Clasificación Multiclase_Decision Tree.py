...
# 5: retrasos entre 75-89 min, 6: retrasos entre 90-104 min, 7: retrasos entre 105-119 min, 8: retrasos entre 120-134 min, 9: retrasos entre 135-149 
# min, 10: retrasos entre 150-164 min, 11: retrasos entre 165-179 min, 12: retrasos de mas de 180 min, 13: llegadas entre 15-1 min de antelacion, 
# 14: llegadas de mas de 15 min de antelacion)
...
dt_multiclase = DecisionTreeClassifier(labelCol="label", featuresCol="features", maxDepth=12, maxBins=64)

# Fit the model
model_multiclase = dt_multiclase.fit(train_LP)

#Save the model
# model_multiclase.save("dbfs:/dataset/modelo_multiclase_DT")
...
# CLASIFICACION MULTICLASE CON DATOS NORMALIZADOS
...
#Definimos el algoritmo del modelo (decision tree)
dt_multiclase = DecisionTreeClassifier(labelCol="label", featuresCol="features", maxDepth=10, maxBins=64)

# Fit the model
model_multiclase = dt_multiclase.fit(training)

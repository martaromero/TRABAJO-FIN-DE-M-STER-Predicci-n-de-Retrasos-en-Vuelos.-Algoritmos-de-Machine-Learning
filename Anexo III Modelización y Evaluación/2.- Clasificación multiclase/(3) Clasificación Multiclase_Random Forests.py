...
rf_multiclase = RandomForestClassifier(labelCol="label", featuresCol="features", numTrees=14, maxDepth=10) 

# Fit the model
model_multiclase = rf_multiclase.fit(train_LP)
...
#Definimos el algoritmo del modelo (random forest)
rf_multiclase = RandomForestClassifier(labelCol="label", featuresCol="features", numTrees=12, maxDepth=10) 

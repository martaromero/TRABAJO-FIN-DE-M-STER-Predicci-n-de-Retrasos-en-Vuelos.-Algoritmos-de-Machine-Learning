...
model_regresion = RandomForestRegressor(labelCol="label", featuresCol="features", maxDepth=11, maxBins=64, numTrees=10)
...
# sameModel_multiclase = model_multiclase.load("dbfs:/dataset/modelo_multiclase_RF")
...
model_regresion = RandomForestRegressor(labelCol="label", featuresCol="scaledFeatures", maxDepth=11, maxBins=64, numTrees=10)

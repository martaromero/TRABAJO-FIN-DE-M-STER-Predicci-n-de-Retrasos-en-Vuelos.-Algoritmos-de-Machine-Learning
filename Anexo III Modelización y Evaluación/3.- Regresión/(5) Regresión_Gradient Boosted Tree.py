...
model_regresion = GBTRegressor (labelCol="label", featuresCol="features", maxDepth=13, maxBins=64, maxIter=10) 
...
#Definimos el algoritmo del modelo (gradient boosted tree)
model_regresion = GBTRegressor (labelCol="label", featuresCol="scaledFeatures", maxDepth=13, maxBins=64, maxIter=10) 
...
#Definimos el algoritmo del modelo (gradient boosted tree)
model_regresion = GBTRegressor (labelCol="label", featuresCol="scaledFeatures", maxDepth=13, maxBins=64, maxIter=11)

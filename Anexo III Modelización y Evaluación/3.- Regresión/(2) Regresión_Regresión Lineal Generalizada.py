...
model_regresion = GeneralizedLinearRegression(family="gaussian", link="identity", maxIter=50, regParam=0.05) 
...
print("Dispersion: " + str(trainingSummary.dispersion))
print("Null Deviance: " + str(trainingSummary.nullDeviance))
print("Residual Degree Of Freedom Null: " + str(trainingSummary.residualDegreeOfFreedomNull))
print("Deviance: " + str(trainingSummary.deviance))
print("Residual Degree Of Freedom: " + str(trainingSummary.residualDegreeOfFreedom))
print("AIC: " + str(trainingSummary.aic))
...
print("RMSE = %s" % root_Mean_Squared_Error)
...
#Definimos el algoritmo del modelo (regresion logistica)
model_regresion = GeneralizedLinearRegression(labelCol="label", featuresCol="scaledFeatures", family="gaussian", link="identity", maxIter=50, regParam=0.05) 

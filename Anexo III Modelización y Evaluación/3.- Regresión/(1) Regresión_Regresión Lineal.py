...
model_regresion = LinearRegression(maxIter=50, regParam=0.05, elasticNetParam=0.05)
...
#Definimos el algoritmo del modelo (regresion logistica)
model_regresion = LinearRegression(labelCol="label", featuresCol="scaledFeatures", maxIter=50, regParam=0.05, elasticNetParam=0.05)

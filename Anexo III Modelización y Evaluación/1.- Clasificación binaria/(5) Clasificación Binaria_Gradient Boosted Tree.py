...
gbt = GBTClassifier (labelCol="label", featuresCol="features", maxDepth=15, maxBins=64, maxIter=10) 

# Fit the model
model = gbt.fit(train_LP)

#Save the model
#model.save("dbfs:/dataset/modelo_binario_GBT")
...
# sameModel = model.load("dbfs:/dataset/modelo_binario_GBT")
...
#Definimos el algoritmo del modelo (gradient boosted tree)
gbt = GBTClassifier (labelCol="label", featuresCol="features", maxDepth=12, maxBins=64, maxIter=10) 
...
# sameModel = model.load("dbfs:/dataset/modelo_binario_DT")

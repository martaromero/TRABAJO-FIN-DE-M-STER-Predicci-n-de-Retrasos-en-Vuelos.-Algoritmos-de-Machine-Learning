...
lr = LogisticRegression(maxIter=50, regParam=0.05, elasticNetParam=0.1)

# Fit the model
model = lr.fit(train_LP)

#Save the model
# model.save("dbfs:/dataset/modelo_binario_LR")
...
# Normalizar datos -> Restar la media a cada variable y dividir por su varianza 
